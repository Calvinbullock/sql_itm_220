...
CREATE TABLE IF NOT EXISTS `mydb`.`language` (
  ...
  UNIQUE INDEX `index3` (`language` ASC, `lang` ASC) VISIBLE)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `mydb`.`country` (
  ...
  UNIQUE INDEX `country_pk` (`country_name` ASC, `country_id` ASC, `lang` ASC) VISIBLE,
  CONSTRAINT `lang_fk`
    FOREIGN KEY (`lang`)
...
CREATE TABLE IF NOT EXISTS `mydb`.`state` (
  ...
  UNIQUE INDEX `state_pk` (`country_id` ASC, `state_name` ASC, `state_id` ASC, `lang` ASC) VISIBLE,
  CONSTRAINT `state_fk`
...
CREATE TABLE IF NOT EXISTS `mydb`.`county` (
  ...
  INDEX `county_nk` (`country_name` ASC, `state_id` ASC) VISIBLE,
  INDEX `lang_fk_idx` (`lang` ASC) VISIBLE,
  INDEX `county_nk` (`lang` ASC, `state_id` ASC, `country_name` ASC) VISIBLE,
  UNIQUE INDEX `county_pk` (`county_id` ASC, `country_name` ASC, `state_id` ASC, `lang` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`city` (
  ...
  INDEX `lang_fk_idx` (`lang` ASC) VISIBLE,
  INDEX `city_nk` (`city_name` ASC, `county_id` ASC, `country_id` ASC, `state_id` ASC, `lang` ASC, `begin_date` ASC, `end_date` ASC) VISIBLE,
  UNIQUE INDEX `city_pk` (`city_id` ASC, `city_name` ASC, `county_id` ASC, `state_id` ASC, `country_id` ASC, `lang` ASC, `begin_date` ASC, `end_date` ASC) VISIBLE,
  CONSTRAINT `city_fk1`
...
CREATE TABLE IF NOT EXISTS `mydb`.`sales_tax` (
  ...
  INDEX `county_fk_idx` (`county_id` ASC) VISIBLE,
  INDEX `state_fk_idx` (`state_id` ASC) VISIBLE,
  INDEX `sales_tax_nk ` (`begin_date` ASC, `end_date` ASC) VISIBLE,
  UNIQUE INDEX `sales_tax_pk` (`begin_date` ASC, `end_date` ASC, `sales_tax_id` ASC, `tax_rate` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`lookup` (
  ...
  INDEX `lookup_nk` (`lookup_table` ASC, `lookup_type` ASC, `lookup_column` ASC, `lookup_lang` ASC, `lookup_meaning` ASC, `start_date` ASC, `end_date` ASC) VISIBLE,
  UNIQUE INDEX `lookup_pk` (`lookup_id` ASC, `lookup_table` ASC, `lookup_column` ASC, `lookup_type` ASC, `start_date` ASC, `end_date` ASC) VISIBLE)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `mydb`.`zip_code` (
  ...
  UNIQUE INDEX `zip_code_pk` (`zip_code_id` ASC, `zip_code` ASC, `start_date` ASC, `end_date` ASC) VISIBLE)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `mydb`.`address` (
  ...
  `address_type_fk` INT UNSIGNED NOT NULL,
  `ship_to_fk` INT UNSIGNED NOT NULL,
  `bill_to_fk` INT UNSIGNED NOT NULL,
  ...
  INDEX `address_lookup_id_idx` (`address_type_fk` ASC) VISIBLE,
  INDEX `address_fk4_idx` (`ship_to_fk` ASC) VISIBLE,
  INDEX `address_fk5_idx` (`bill_to_fk` ASC) VISIBLE,
  ...
  CONSTRAINT `address_fk3`
    FOREIGN KEY (`address_type_fk`)
    REFERENCES `mydb`.`lookup` (`lookup_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `address_fk4`
    FOREIGN KEY (`ship_to_fk`)
    REFERENCES `mydb`.`lookup` (`lookup_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `address_fk5`
    FOREIGN KEY (`bill_to_fk`)
    REFERENCES `mydb`.`lookup` (`lookup_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE TABLE IF NOT EXISTS `mydb`.`account` (
  ...
  `account_nummber` VARCHAR(20) NOT NULL,
  `account_type_fk` INT UNSIGNED NOT NULL,
  `active_flag` VARCHAR(1) NOT NULL,
  `credit_card_id` INT UNSIGNED NOT NULL,
  PRIMARY KEY (`account_id`),
  INDEX `account_nk` (`account_type_fk` ASC, `active_flag` ASC, `account_nummber` ASC) VISIBLE,
  UNIQUE INDEX `account_pk` (`account_id` ASC, `account_nummber` ASC, `account_type_fk` ASC, `active_flag` ASC) VISIBLE)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `mydb`.`customer` (
  ...
  INDEX `customer_fk1_idx` (`account_id` ASC) VISIBLE,
  INDEX `customer_nk` (`customer_number` ASC, `first_name` ASC, `middle_name` ASC, `last_name` ASC) VISIBLE,
  UNIQUE INDEX `customer_pk` (`customer_id` ASC, `customer_number` ASC, `first_name` ASC, `middle_name` ASC, `last_name` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`preferred_address` (
  ...
  `start_date` DATE NOT NULL,
  `end_date` DATE NOT NULL,
  `preferred_address_fk1` INT UNSIGNED NOT NULL,
  PRIMARY KEY (`preferred_address_id`),
  INDEX `preferred_address_fk1_idx` (`preferred_address_fk1` ASC) VISIBLE,
  CONSTRAINT `preferred_address_fk1`
    FOREIGN KEY (`preferred_address_fk1`)
    REFERENCES `mydb`.`zip_code` (`zip_code_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `mydb`.`credit_card` (
  ...
  `exspiration_date` DATE NOT NULL,
  `cvv` VARCHAR(3) NOT NULL,
  `account_id` INT UNSIGNED NOT NULL,
  `credit_card_fk1` INT UNSIGNED NOT NULL,
  PRIMARY KEY (`credit_card_id`),
  INDEX `credit_card_fk1_idx` (`credit_card_fk1` ASC) VISIBLE,
  INDEX `credit_card_nk` (`credit_card_number` ASC, `credit_card_type` ASC, `exspiration_date` ASC, `cvv` ASC) VISIBLE,
  UNIQUE INDEX `credit_card_pk` (`credit_card_id` ASC, `credit_card_number` ASC, `credit_card_type` ASC, `exspiration_date` ASC, `cvv` ASC) VISIBLE,
  CONSTRAINT `address_fk4`
    FOREIGN KEY (`credit_card_fk1`)
    REFERENCES `mydb`.`account` (`account_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
